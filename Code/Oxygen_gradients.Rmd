...
geom_point(aes(y = DO_µg_L, x = Depth_cm)) + labs( title= "Oxygen Gradients", caption= "Figure X. Dissolved Oxygen (DO) (µg/L) measured in four Winogradsky colums at 5 depths (cm)") + theme(plot.caption= element_text(size = 11, hjust=0)) +
  #geom_path(aes(y = Depth_cm, x = DO_µg_L)) +
  facet_wrap(vars(unlist(Sample))) + scale_y_continuous(limits = c(0, 300))
```
